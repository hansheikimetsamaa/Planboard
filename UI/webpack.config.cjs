...
module.exports = (env = {}, argv) => {
  ...
  if (deploy && !userDataPath)
    throw new Error("Cannot deploy Planboard UI: CSII user-data path is unavailable.");
      ...
      rules: [
        { test: /\.tsx?$/, use: "ts-loader", exclude: /node_modules/ },
        {
          ...
          use: [
            ...
            {
              loader: "css-loader",
              options: { modules: { auto: true, exportLocalsConvention: "camelCase" } },
            },
            "sass-loader",
          ],
        },
