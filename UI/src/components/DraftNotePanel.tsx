...
style={{ ...geometry.panelStyle, height: "auto" }} onMouseUp={geometry.onPanelMouseUp} className={styles.shell} contentClassName={styles.compactContent} header={<div className={styles.header}><strong>Pin placed</strong><span>Complete the note</span></div>} showCloseHint onClose={discard}>
