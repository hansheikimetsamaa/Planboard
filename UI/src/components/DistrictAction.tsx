// Offers the district-selection shortcut for creating a location-aware task.
  ...
  return (
    <InfoSection disableFoldout>
      <div className={styles.action}>
        ...
        <Button variant="flat" onSelect={() => trigger(Binding.group, Binding.createDistrictEntry)}>
          + {t("AddDistrict", "Add to Planboard")}
        </Button>
      </div>
    </InfoSection>
  );
